...

    {
      callback = lib.nixvim.mkRaw ''
        function()
          ...
          vim.g.python3_host_prog = vim.fn.expand("%:p:h") .. "/.devenv/state/venv/bin/python3"

          vim.keymap.set("n", "<LocalLeader>oo", "<Cmd>noautocmd MoltenEnterOutput<CR>", { desc = "Open Output Window", silent = true })
          vim.keymap.set("n", "<LocalLeader>oh", "<Cmd>MoltenHideOutput<CR>", { desc = "Close Output Window", silent = true })
          vim.keymap.set("n", "<LocalLeader>d", "<Cmd>MoltenDelete<CR>", { desc = "Delete Molten Cell", silent = true })

          local runner = require("quarto.runner")

          vim.keymap.set("n", "<LocalLeader>A", runner.run_all, { desc = "Run All", silent = true })
